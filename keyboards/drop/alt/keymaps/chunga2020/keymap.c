...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_65_ansi_blocker(
        ...
        _______, RM_TOGG, RM_VALU, RM_SPDU, RM_HUEU, _______, _______, _______, _______, _______, KC_PSCR, KC_SCRL, KC_PAUS, _______, KC_END, 
        _______, _______, RM_VALD, RM_SPDD, RM_HUED, _______, _______, _______, _______, _______, _______, _______,          _______, KC_VOLU,
